//
//  SignUpTextFieldContainerView.swift
//  EZY
//
//  Created by 노연주 on 2021/09/27.
//
...
class SignUpTextFieldContainerView: UIView {
    ...
    func loginTfSetting(screenHeight: CGFloat, screenWidth: CGFloat){
        ...
        tf.snp.makeConstraints { make in
            make.top.equalTo(tfTitle.snp.bottom).offset(screenHeight/90.22)
        ...
        divView.snp.makeConstraints { make in
            make.top.equalTo(tf.snp.bottom).offset(screenHeight/90.22)
            make.centerX.equalToSuperview()
